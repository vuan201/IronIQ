...
public interface IWorkoutSessionRepository
{
    ...
    Task<int> CountCompletedByUserAsync(Guid userId, CancellationToken ct = default);
    Task<int> CountCompletedSetsByUserAsync(Guid userId, CancellationToken ct = default);
